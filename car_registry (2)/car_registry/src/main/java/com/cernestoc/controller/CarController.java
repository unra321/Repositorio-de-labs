...
public class CarController {
    ...
    public ResponseEntity<?> getAllCars(){
        log.info("Retrieving info of  all cars");
            try {
                ...
                List<CarResponse> carResponses = carMapper.toList(carList);
    ...
    @PreAuthorize("hasRole('VENDOR')")
    public ResponseEntity<?> updateCarById(@PathVariable Integer id, @RequestBody Car carRequest){
    ...
    @PreAuthorize("hasAnyRole('CLIENT','VENDOR')")
    public ResponseEntity<?> donloadCars() {
