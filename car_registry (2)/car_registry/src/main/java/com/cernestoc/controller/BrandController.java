...
public class BrandController {
    ...
    public ResponseEntity<?> addBrand(@RequestBody Brand brandRequest){
    ...
    @GetMapping("/getAll")
    @PreAuthorize("hasAnyRole('CLIENT','VENDOR')")
    public CompletableFuture<?> getAllBrands() throws ExecutionException{
        log.info("Retrieving brand info");
        try {
    ...
    public ResponseEntity<?> updateBrandById(@PathVariable Integer id, @RequestBody Brand brandRequest){
